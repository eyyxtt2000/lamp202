...
@section('content')
    ...
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span > <i class="icon-magic"></i>修改广告</span>
        </div>
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/admin/advertise/{{ $data->id }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                {{ method_field('PUT') }}
                ...
                <div class="mws-form-block">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input type="text" name="advertise_https" class="small" placeholder="广告地址" value="{{ $data->advertise_https }}">
                        </div>
                    </div>
